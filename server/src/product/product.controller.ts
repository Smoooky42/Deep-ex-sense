...
export class ProductController {
	...
	@ApiCreatedResponse({
		...
		description: 'Создание информации о продукте'
	})
	@HttpCode(200)
	@Auth()
	@UsePipes(new ValidationPipe())
	@Post('/productInfo/:id')
	async createProductsInfo(
	...
	@ApiCreatedResponse({
		type: Boolean,
		description: 'Удаление информации о продукте'
	})
	@HttpCode(200)
	@Auth()
	@UsePipes(new ValidationPipe())
